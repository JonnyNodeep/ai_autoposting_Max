...
TTS_PROVIDER_SUNOR = "sunor"
TTS_PROVIDERS = (TTS_PROVIDER_SUNOR, TTS_PROVIDER_OPENAI, TTS_PROVIDER_SPEECHKIT)

DEFAULT_TTS_PROVIDER = TTS_PROVIDER_SUNOR
DEFAULT_SPEECHKIT_VOICE = "dasha"
DEFAULT_SPEECHKIT_SPEED = 0.9
DEFAULT_SPEECHKIT_PITCH_SHIFT = 0
...
TTS_PITCH_SHIFTS = (-100, -50, 0, 50, 100)
